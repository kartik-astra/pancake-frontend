...
interface TrustWalletEvents {
  ...
  accountChanged(newAccount: unknown): unknown
}
...
export const TrustAccountsWalletName = 'TrustAccounts' as WalletName<'TrustAccounts'>

export class TrustAccountsWalletAdapter extends BaseMessageSignerWalletAdapter {
  name = TrustAccountsWalletName
